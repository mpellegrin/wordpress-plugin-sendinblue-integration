...
<body>
    <table class="main-template" style="background-color:#d6d6d6;" cellspacing="0" cellpadding="0" border="0" bgcolor="#d6d6d6" align="center" width="100%">
        <tbody>
            ...
            <tr>
                <td align="center" valign="top">
                    <!--[if gte mso 9]> <table align="center" border="0" cellspacing="0" cellpadding="0" width="590" style="width:590px;"> <tr> <td align="center" valign="top" width="590" style="width:590px;"> <![endif]-->
                    <table class="templateContainer" style="max-width:590px!important; width: 590px;" cellspacing="0" cellpadding="0" border="0" width="100%">
                        <tbody>
                            <tr>
                                <td style="background-color:#d6d6d6;" bgcolor="#d6d6d6" align="center" valign="top">
                                    <table class="rnb-del-min-width rnb-tmpl-width" style="min-width:590px; background-color:#d6d6d6" name="Layout_0" id="Layout_0" cellspacing="0" cellpadding="0" border="0" bgcolor="#d6d6d6" width="100%">
                                        <tbody>
                                            <tr>
                                                <td class="rnb-del-min-width" style="min-width: 590px; background-color: rgb(214, 214, 214);" align="center" valign="top">
                                                    <table style="background-color: rgb(85, 85, 85);" cellspacing="0" cellpadding="0" border="0" align="center" width="100%">
                                                        <tbody>
                                                            <tr>
                                                                <td style="font-size:1px; line-height:1px;" height="10">&nbsp;</td>
                                                            </tr>
                                                            <tr>
                                                                <td style="font-size: 13px; color: rgb(255, 255, 255); font-weight: normal; text-align: center; font-family: Arial,Helvetica,sans-serif;" align="center" height="20"> <span style="color: rgb(255, 255, 255); text-decoration: none;"> <a target="_blank" href="[MIRROR]" style="text-decoration: none; color: rgb(255, 255, 255);"><?php echo _e('See online version'); ?></a></span> </td>
                                                            </tr>
                                                            <tr>
                                                                <td style="font-size:1px; line-height:1px;" height="10">&nbsp;</td>
                                                            </tr>
                            ...
                            <tr>
                                <td style="background-color:#d6d6d6;" bgcolor="#d6d6d6" align="center" valign="top">
                                    <div>
                                        ...
                                        <!--[if mso]> <td valign="top" width="590" style="width:590px;"> <![endif]-->
                                        <table class="rnb-del-min-width" style="min-width:590px; background-color:#d6d6d6;" name="Layout_1" id="Layout_1" cellspacing="0" cellpadding="0" border="0" bgcolor="#d6d6d6" width="100%">
                                            <tbody>
                                                <tr>
                                                    <td class="rnb-del-min-width" style="min-width:590px; background-color: #d6d6d6;" bgcolor="#d6d6d6" align="center" valign="top">
                                                        <table class="rnb-container" style="background-color: rgb(214, 214, 214); border-radius: 0px; padding-left: 20px; padding-right: 20px; border-collapse: separate;" cellspacing="0" cellpadding="0" border="0" bgcolor="#d6d6d6" width="100%">
                                                            <tbody>
                                                                <tr>
